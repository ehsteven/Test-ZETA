...
const { getProducts: getProducts_controller, createProduct: createProduct_controller, updateProduct: updateProduct_controller, deleteProduct: deleteProduct_controller } = require('../controller/productController');
